...
// RemoteAddr implements the Peer Interface and will return the remote address of the underlying connection
...
// for reading incoming message coming from another peer
